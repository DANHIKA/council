...
function Button({
  ...
  return (
    <ButtonPrimitive
      ...
      render={render}
      // When a render prop is provided (e.g. <Link> or <a>), the element is
      // no longer a native <button> — suppress the Base UI warning automatically.
      nativeButton={nativeButton ?? (render !== undefined ? false : true)}
      {...props}
    />
  )
}
